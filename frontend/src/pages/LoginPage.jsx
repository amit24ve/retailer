    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div
                    className="absolute -bottom-40 -right-40 w-96 h-96 bg-cyan-500/5 rounded-full blur-3xl animate-float"
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                {/* <div className="bg-white p-4 border border-slate-200 rounded-2xl shadow-sm mb-4">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        {DEMO_CREDENTIALS.map((cred) => (
                            ...
                            >
                                <p className="text-xs font-semibold text-slate-700 group-hover:text-primary-700 truncate">
                                    {cred.role}
                                </p>
                ...
                <p className="text-center text-xs text-slate-400 mt-6">
                    Cuben Retailer Platform, Enterprise Edition
                </p>
            </div>
        </div>
    );
